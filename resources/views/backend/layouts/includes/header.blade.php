        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('dashboard') }}" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('uploads/' . setting()->logo) }}" alt="" height="24"> <span
                            class="logo-txt">{{ setting()->site_name }}</span>
                    </span>
                </a>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="#">
                        <i class="align-middle mdi mdi-lock font-size-16 me-1"></i> Lock Screen
                    </a> --}}
